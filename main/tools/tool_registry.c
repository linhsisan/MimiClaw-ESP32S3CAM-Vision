...
esp_err_t tool_registry_init(void)
{
    ...
    mimi_tool_t tp = {
        .name = "take_photo",
        .description = "Take a photo and send it to the current Telegram chat. The runtime supplies chat_id.",
        .input_schema_json = "{\"type\":\"object\",\"properties\":{\"chat_id\":{\"type\":\"string\",\"description\":\"Injected by runtime; do not invent a value\"}}}",
