...
/*
//  MiniMax 
#define MIMI_LLM_DEFAULT_MODEL       "MiniMax-M3"
...
/*
// deepseek-v4-flash 
#define MIMI_LLM_DEFAULT_MODEL       "deepseek-v4-pro" //"deepseek-chat"  //"deepseek-v4-flash"
#define MIMI_LLM_PROVIDER_DEFAULT    "openai"
#define MIMI_LLM_MAX_TOKENS          4096
...
#define MIMI_LLM_PROVIDER_DEFAULT    "openai"git 
#define MIMI_LLM_MAX_TOKENS          4096
...
// ==========================================
// 📍 自定義硬體腳位設定 (Hardware Pins)
// ==========================================

// [螢幕 SPI 腳位 (ST7789 2.8吋)]
// 注意：TFT_eSPI 庫主要認 User_Setup.h，但定義在這裡方便全域查閱與其他模組共用
#define PIN_TFT_MISO   46
...
// [馬達與燈光]
#define PIN_SERVO      40   // 伺服馬達
#define PIN_WS2812     48   // RGB 燈光

// [感測器]
#define PIN_DHT        2    // DHT11 溫濕度 (建議加 4.7k 上拉電阻)
#define PIN_ADC        1    // 類比讀取電位器
